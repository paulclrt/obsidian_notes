...
Qu'est-ce que qu'une relation d'équivalence ?
?
...
- puissance/dérivé de deux fonctions équivalentes
- limite d'une fonction et impact sur son équivalence
?
...
- Si $f \sim g$ et si $g(x) \longmapsto l$ quand $x\rightarrow a$, alors $f (x) \longmapsto l$ en a
BONUS:
